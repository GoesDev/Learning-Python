...
# uma frase que descreva o teste e o resultado previsto para cada um.
# Seu código deverá ser semelhante a: car = 'subaru'
...
game = 'Old Dragon'
print("Is game == 'Old Dragon'? I predict True")
print(game == 'Old Dragon')

print("Is game == 'Old Dragon'? I predict False")
print(game == 'D&D')
