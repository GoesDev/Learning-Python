...
# • Acrescente uma linha no final de seu programa, fora do laço for, que
# informe quanto você gosta de pizza. A saída deve ser constituída de três ou
# mais linhas sobre os tipos de pizza que você gosta e de uma frase adicional,
# por exemplo, Eu realmente adoro pizza!

pizzas = ['Toscana', 'Calabresa', 'Lombo']

for pizza in pizzas:
    print(f"Gosto de pizza {pizza}")
